                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="mt-4 text-gray-600 max-w-md">
                            Making food delivery more affordable, fast, and convenient for students living in dorms and nearby apartments.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li className="text-gray-600">
                                <a href="mailto:contact@studeliver.com" 
                                   className="hover:text-blue-600 transition-colors">
                                    contact@studeliver.com
                                </a>
                            </li>
                            <li className="text-gray-600">
                            ...
                            <li className="pt-2">
                                <div className="flex space-x-4">
                                    {[
                                        ...
                                        <a
                                            key={title}
                                            href={`https://${title.toLowerCase()}.com/studeliver`}
                                            target="_blank"
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-600 text-sm">
                            © {currentYear} Studeliver. All rights reserved.
                        </p>
